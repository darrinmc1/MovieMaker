...
CHARACTERS = {
    ...
    "Serana": {
        "base": (
            "Woman in her mid-to-late 40s — not elderly but unmistakably middle-aged, earned and weathered. "
            "Face marked by decades of hard campaigning: deep laugh lines, crow's feet at the eyes, "
            "a jaw that has set firm from years of difficult decisions. Strong and capable, not soft. "
            "Hair that was once chestnut brown now heavily streaked with grey and silver, "
            "pulled back practically — some strands escaping at the temples. "
            "Tall and straight-backed with the bearing of someone trained in grand halls of power, "
            "but the posture of someone who has carried real weight for a long time. "
            "Road-worn white and gold plate armor that was once magnificent — now sun-bleached, "
            "patinated with age and travel, dented and repaired many times over, telling a long story. "
            "Silver Dawn-crest medallion at her throat (sunburst design), the one thing kept well-polished. "
            "Calm controlled expression, quiet authority — someone who has seen too much to be rattled. "
            "NOT young, NOT youthful — middle-aged, experienced, formidable."
        ),
        "poses": [
    ...
    "Elowen": {
        "base": (
            "Woman in her late 30s to early 40s — a mother figure, warm and grounded and quietly strong. "
            "NOT young, NOT girlish — her face carries gentle age: soft lines around the eyes from smiling and grief, "
            "a calm that only comes from having carried other people's pain for years. "
            "Sturdy build, strong from decades of outdoor living — not delicate, not fragile, someone you would lean on. "
            "Auburn hair now threaded with early grey strands, curls loose and natural with small living blossoms "
            "woven throughout — flowers that actually grow from her hair, changing with her emotions. "
            "Earth-brown eyes, deeply warm and kind — the eyes of someone who has seen suffering and chosen compassion anyway. "
            "Fair skin with sun-freckles, laughter lines at the corners of her eyes and mouth. "
            ...
            "Moss-green robes of natural fibers, practical and worn. Lichen-coloured cloak. Often barefoot. "
            "Seed pouches and herb bundles at belt. The feeling of someone who will feed you before asking if you are hurt."
        ),
        "poses": [
