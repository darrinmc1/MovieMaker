        ...
        generationConfig: {
            ...
            responseSchema: {
                ...
                properties: {
                    ...
                    newCharactersFound: {
                        type: SchemaType.ARRAY,
                        description: "Characters that are introduced or mentioned in the text that are NOT in the existing character list.",
                        items: {
                            type: SchemaType.OBJECT,
                            properties: {
...
You must also identify any NEW characters introduced in the text that are not in the existing database.
Return the exact JSON structure requested.

Existing characters: ${charactersData.map(c => c.name).join(', ')}
